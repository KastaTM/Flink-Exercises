...
public class Exercise9 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<TemperatureEvent> eventStream = env.readTextFile(params.get("input"))
        .map(new MapFunction<String, TemperatureEvent>() {
            ...
            public TemperatureEvent map(String value) throws Exception {
                ...
                Thread.sleep(1000);
                return new TemperatureEvent(Integer.parseInt(fieldArray[0]),
                        Double.parseDouble(fieldArray[2]), Long.parseLong(fieldArray[1]));
            }
        });

        // Assign timestamps and generate watermarks to manage clutter
